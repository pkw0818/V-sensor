# -*- coding: utf-8 -*-
"""
Created on Wed Jul 31 19:26:37 2013
...
k=math.sqrt(23./2);           # K dot P matrix element
...
CB_value=[4.09,0.8,0,4.09]
VB_value=[4.09,0,0.52,4.09]
...
for x1 in range(n):
    for x2 in range(x1+1):
        ...
        Ve_lower[x1,x2]=1/(abs(X[x1]-X[x2])+delta)
...
# dos_Ef=1/pi/hbar*sqrt(m*mh1/2/Eex/e)*2*Qw          # 1D DOS NW #[1/J)]
#dos_Ef=m*mh1/pi/hbar/hbar*e                       # 2D DOS
...
delta_E=Cb_energy-Cb[(n-1)/2]-Vb_energy-Vb[(n-1)/2-1]
