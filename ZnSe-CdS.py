...
def ZnSe_CdS(sweep):
    ...
    #Define Geometry
    L=14e-9;                # Sim. length L >> QW (confined area)
    Qw = 5e-9
    space=0.5e-10;
    ...
    kf=sqrt(2*m*mh1*e*(Cb_energy-Eg/2+2*abs(Vb_energy+Eg/2)+Eg))/hbar  # [1/m]
    ...
    Eex=kf**(2)*hbar**(2)/2/m/mh1/e-Vbo               #[eV]
    ...
    return delta_E, kA, overlap_integral, psi_e_norm
