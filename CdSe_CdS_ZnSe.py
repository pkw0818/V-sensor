# -*- coding: utf-8 -*-
"""
Created on Thu Sep 12 19:35:22 2013
...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep 12 16:08:23 2013
...
n= X.size
region=[-L,-Qw, -Qw+1e-9, -Qw+3e-9,-2e-9,2e-9,Qw,L]
...
plot(abs(e_h2_multiple))
#plot(abs(psi_e_norm))
#plot(abs(psi_h_norm))
#plot(abs(psi_h2_norm))
#return delta_E, delta_E2, overlap_integral, overlap_integral2, psi_h_norm
